...
font-size: 16px;"> <?php echo $lang['last_access']; ?> : 11-11-2016 &nbsp; <a onclick="redirect('login.php')" class="btn btn-danger square-btn-adjust"><?php echo $lang['logout']; ?></a></div>
		...
		<nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li>
                        <a class="active-menu" onclick="redirect('groups.php')"><i class="fa fa-address-book-o fa-3x"></i><span><?php echo $lang['groups']; ?></span></a>
                    </li>	
					<li>
		...
		<div id="page-wrapper" >
			<div id="page-inner">		
				...
				<h2><?php echo $lang['existing_groups']; ?></h2>
				<hr>
				...
				<table class="responstable">
				  ...
				  <tr>
					...
					<th><?php echo $lang['numb_of_mem']; ?></th>
				  ...
				  <tr style="background-color: #4D4D4D">
					...
					<td><input style="border-radius: 5px" type="text" placeholder=" <?php echo $lang['numb_of_mem']; ?>" ></td>
					<td style="text-align: center"><button id="add" class="btn btn-success btn-xs"><span class="fa fa-check"></span></button></td>
				  </tr>
				</table>
